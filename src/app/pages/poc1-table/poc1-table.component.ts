...
export class Poc1TableComponent implements OnInit {
  ...
  constructor() {
    ...
    this.tableData = [
      ...
      { id: '2', cgf: 'COMÉRCIO ATACAREJO RS - 432764', notaGeral: 4, historico: '', pesoNaNotaGeral: 75 },
      ...
      { id: '8', cgf: 'COMÉRCIO ATACAREJO SP - 120198', notaGeral: 5, historico: '', pesoNaNotaGeral: 29 }
    ];
  }
