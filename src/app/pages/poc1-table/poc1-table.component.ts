...
export class Poc1TableComponent implements OnInit {
  ...
  constructor() {
    /* dados mockados */
    this.tableData = [
      { id: '1', cgf: 'COMÉRCIO ATACAREJO RJ - 500653', notaGeral: 4, historico: '', pesoNaNotaGeral: 2.5, empty: '' },
      ...
      { id: '4', cgf: 'COMÉRCIO ATACAREJO DF - 300510', notaGeral: 3, historico: '', pesoNaNotaGeral: 2.4, empty: '' },
      ...
      { id: '7', cgf: 'COMÉRCIO ATACAREJO RJ - 827774', notaGeral: 3, historico: '', pesoNaNotaGeral: 2.9, empty: '' },
